  ...
  useEffect(() => {
    ...
    if (raw.length > 0) {
      ...
      if (serverList.length > 0) {
        ...
        // Auto-expand if user already has more than 3 photos saved
  ...
  return (
    <Container>
      ...
      <View className="flex-row items-center justify-between py-3 border-b border-slate-100 mb-2">
        ...
        <Text className="font-bold text-[18px] text-slate-800">Club Photos</Text>
        <View className="flex-row items-center rounded-full bg-rose-50 px-3 py-1 border border-rose-100">
          <Ionicons name="images" size={13} color="#F6163C" />
          <Text className="ml-1 text-xs font-bold text-[#F6163C]">
      ...
      <ScrollView
        ...
        <View className="mt-2 mb-5">
          <Text className="font-bold text-[24px] text-slate-900">Facility & Gym Photos</Text>
