    ...
    <Container>
      {/* <View className="flex-1 bg-white"> */}
        ...
        <View className="flex-row items-center justify-between py-4">
          ...
          <Text className="font-bold text-lg text-slate-800">Earnings Detail</Text>
        ...
        <View className="mt-2 rounded-[24px] border border-[#E5E7EB] bg-white p-5   ">
          ...
          <View className="flex-row items-center justify-between py-6">
            <Text className="text-lg text-slate-500">Net Credited</Text>
            <Text className="font-bold text-2xl text-slate-900">{params.price || '₹699'}</Text>
          </View>
